...
internal class HotComics(context: MangaLoaderContext) :
	HotComicsParser(context, MangaParserSource.HOTCOMICS, "hotcomics.me") {

	override val homeUrl = "/en"
	override val latestUrl = "/en/new"
	override val mangasUrl = "/en/genres"
	override val searchUrl = "/en/search"
}
